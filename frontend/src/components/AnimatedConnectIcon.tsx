...
export interface AnimatedConnectIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

type AnimatedConnectIconProps = HTMLAttributes<HTMLDivElement> & {
  size?: number;
};
...
export const AnimatedConnectIcon = forwardRef<AnimatedConnectIconHandle, AnimatedConnectIconProps>(
...
AnimatedConnectIcon.displayName = "AnimatedConnectIcon";
