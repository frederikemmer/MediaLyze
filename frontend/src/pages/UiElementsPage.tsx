                    ...
                    <div className="transcode-filename-body" id="catalog-transcode-filename">
                      ...
                      <div className="transcode-filename-metadata-tools">
                       ...
                       <div className="transcode-filename-options-row">
                         ...
                         <label className="transcode-filename-field transcode-language-code-field"><span className="transcode-field-label">Language code format</span><select className="settings-choice-input transcode-control" aria-label="Language code format (Filename formatting)" defaultValue="iso_639_1"><option value="iso_639_1">Two letters</option><option value="iso_639_2">Three letters</option></select></label>
                       </div>
