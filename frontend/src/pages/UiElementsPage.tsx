        ...
        <div className="ui-elements-content">
          ...
          <CatalogSection definition={catalogSections[2]}>
            <VariantGroup title="Navigation and settings controls">
              ...
              <VariantCard title="Compatibility profile list" source={`${settings} > Hard/Software Profiles`} status="Favorite profile actions use a filled neutral surface without an outline when active" classes={["compatibility-profile-list", "compatibility-profile-search", "compatibility-profile-list-item", "compatibility-profile-list-row", "quality-profile-list-row", "compatibility-profile-list-trigger", "compatibility-profile-quick-actions", "transcode-automation-list-copy", "compatibility-profile-list-copy", "compatibility-profile-details", "settings-choice-input"]} wide>
