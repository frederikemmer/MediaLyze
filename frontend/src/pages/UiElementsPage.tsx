        ...
        <div className="ui-elements-content">
          ...
          <CatalogSection definition={catalogSections[10]}>
            <VariantGroup title="Duplicates, paths, telemetry">
              ...
              <VariantCard title="Compact transcoding plan" source="TranscodingPanel" status="Stream tabs use the fixed 40px Settings row height; search covers source metadata; audio and subtitle rows lead with language; metadata settings use a tooltip list" classes={["panel-header", "panel-title-row", "async-panel-header-status", "transcoding-panel", "transcode-preset-header-slot", "transcode-preset-select", "transcode-original-card", "transcode-control", "settings-choice-input", "transcode-progress", "transcode-progress-compact", "transcode-progress-compact-content", "transcode-progress-center-link", "transcode-progress-actions", "transcoding-progress-summary", "transcoding-progress-metrics", "transcoding-progress-metric", "transcoding-progress-chart", "transcoding-progress-meta", "compatibility-profile-list", "transcode-stream-catalog", "transcode-stream-tabs", "transcode-stream-tab", "transcode-stream-tab-count", "transcode-stream-tabpanel", "transcode-stream-list", "transcode-stream-search", "compatibility-profile-search", "compatibility-profile-search-icon", "compatibility-profile-search-clear", "transcode-stream-list-item", "is-dropped", "transcode-stream-list-row", "transcode-stream-row-actions", "transcode-stream-row-trigger", "transcode-stream-row-copy", "transcode-stream-format", "is-language-first", "transcode-stream-default-button", "compatibility-profile-quick-action", "transcode-stream-action-icon", "transcode-action-field", "transcode-action-select", "transcode-stream-details", "transcode-stream-copy-details", "transcode-stream-copy-note", "transcode-stream-encode-fields", "transcode-video-encode-fields", "transcode-control-field", "transcode-field-label", "transcode-dynamic-range-field", "transcode-codec-field", "transcode-preset-field", "transcode-range-row", "transcode-quality-range", "transcode-range-value", "transcode-filename-section", "transcode-folder-section", "transcode-metadata-settings", "transcode-filename-header", "transcode-filename-header-tooltip", "transcode-filename-chevron-toggle", "transcode-filename-toggle", "transcode-filename-chevron", "transcode-formatting-toggle", "transcode-formatting-preset-select", "transcode-filename-body", "transcode-filename-template-input", "transcode-filename-template-editor", "transcode-filename-inline-token", "transcode-filename-inline-text", "transcode-filename-metadata-tools", "transcode-filename-metadata-toggle", "transcode-filename-token-list", "transcode-filename-token-pill", "transcode-filename-token-tooltip-portal", "transcode-filename-token-tooltip", "transcode-filename-token-tooltip-heading", "transcode-filename-token-tooltip-example", "transcode-filename-options-row", "transcode-filename-divider-field", "transcode-filename-cleanup", "transcode-filename-cleanup-heading", "transcode-filename-cleanup-control", "transcode-filename-field", "transcode-filename-preview", "transcode-folder-scope-hint", "transcode-metadata-option-list", "transcode-global-option", "transcode-global-option-label", "transcode-global-option-select", "toggle-switch", "toggle-switch-track", "toggle-switch-thumb", "transcode-action-button"]} wide>
                <div className="transcoding-panel">
                  <div className="panel-header">
                    ...
                    <div className="async-panel-header-status"><div className="transcode-preset-header-slot"><select className="settings-choice-input transcode-control transcode-preset-select" aria-label="Select preset" defaultValue=""><option value="" disabled>Select preset</option><option value="compatibility">Original / copy</option><option value="modern">Modern AV1</option><option value="expert">Custom</option></select></div></div>
                  </div>
              ...
              <VariantCard title="Standalone accelerators panel: collapsed by default" source={`${settings} > Transcoding > Accelerators`} classes={["app-settings-section", "transcode-automation-section", "compatibility-profile-panel", "transcode-automation-content", "settings-profile-toggle-row", "transcode-automation-toggle-row", "transcode-automation-standalone-header", "transcode-automation-standalone-heading", "transcode-automation-section-chevron", "settings-profile-toggle-actions", "settings-panel-header-action", "transcode-automation-panel-body", "transcode-capability-section", "transcode-capability-content", "transcode-capability-list", "compatibility-profile-list", "panel-empty-state", "panel-empty-state-icon"]}>
                <section className="app-settings-section transcode-automation-section">
                  <div className="compatibility-profile-panel transcode-automation-content">
                    <div className="settings-profile-toggle-row transcode-automation-toggle-row transcode-automation-standalone-header" data-settings-search-target="transcoding-accelerators">
                      <button type="button" className="transcode-automation-section-chevron" aria-label="Expand Accelerators" title="Expand Accelerators" aria-expanded="false" aria-controls="catalog-accelerators-body"><ChevronRight aria-hidden="true" className="nav-icon" /></button>
                      <div className="transcode-automation-standalone-heading"><strong>Accelerators</strong><TooltipTrigger ariaLabel="Explain accelerators" tooltipClassName="transcode-automation-description-tooltip-portal" maxWidth={460} content={<div className="transcode-matrix-meta"><strong>FFmpeg: ffmpeg version test</strong><p>Hardware counts use representative codec pairs and repeated measurements.</p></div>}>?</TooltipTrigger></div>
                      <div className="settings-profile-toggle-actions"><button type="button" className="secondary small settings-panel-header-action"><FlaskConical aria-hidden="true" size={16} />Test Hardware</button></div>
                    </div>
              ...
              <VariantCard title="Tested transcoding settings and compact accelerator matrix · local and federation origins" source={`${settings} > Transcoding (after Test Hardware)`} classes={["panel-header", "panel-title-row", "async-panel-header-status", "settings-panel-header-action", "settings-sidebar-stack", "app-settings-performance-grid", "field", "field-label-row", "app-settings-section", "transcode-automation-section", "transcode-automation-content", "transcode-automation-panel-body", "transcode-automation-standalone-header", "transcode-automation-standalone-heading", "transcode-automation-section-chevron", "settings-profile-toggle-actions", "transcode-automation-tab-content", "transcode-capability-section", "transcode-capability-content", "transcode-capability-list", "compatibility-profile-list", "compatibility-profile-list-item", "compatibility-profile-list-trigger", "transcode-automation-list-copy", "transcode-capability-device-copy", "transcode-capability-device-name", "transcode-capability-device-icon", "transcode-capability-device-icon-gpu", "transcode-capability-device-icon-cpu", "transcode-federation-member-pill", "transcode-federation-local-pill", "transcode-device-matrix", "transcode-matrix-table", "transcode-matrix-cell-trigger", "transcode-matrix-tooltip-preview", "transcode-matrix-tooltip-content", "transcode-matrix-tooltip-heading", "transcode-matrix-tooltip-status", "transcode-matrix-tooltip-row", "transcode-matrix-tooltip-path", "transcode-matrix-tooltip-path-arrow", "transcode-matrix-tooltip-benchmark", "transcode-matrix-tooltip-workload", "transcode-matrix-tooltip-summary", "transcode-matrix-tooltip-level", "transcode-matrix-tooltip-runs", "transcode-matrix-tooltip-level-result", "transcode-matrix-axis-label", "transcode-matrix-axis-label-horizontal", "transcode-matrix-axis-label-vertical", "transcode-replacement-warning"]} wide>
                ...
                <div className="settings-sidebar-stack">
                  ...
                  <section className="app-settings-section transcode-automation-section">
                    <div className="compatibility-profile-panel transcode-automation-content">
                      <div className="settings-profile-toggle-row transcode-automation-toggle-row transcode-automation-standalone-header" data-settings-search-target="transcoding-accelerators">
                        <button type="button" className="transcode-automation-section-chevron" aria-label="Collapse Accelerators" title="Collapse Accelerators" aria-expanded="true" aria-controls="catalog-tested-accelerators-body"><ChevronDown aria-hidden="true" className="nav-icon" /></button>
                        <div className="transcode-automation-standalone-heading"><strong>Accelerators</strong><TooltipTrigger ariaLabel="Explain accelerators" content="Inspect the real FFmpeg hardware probes.">?</TooltipTrigger></div>
                        <div className="settings-profile-toggle-actions"><button type="button" className="secondary small settings-panel-header-action"><FlaskConical aria-hidden="true" size={16} />Test Hardware</button></div>
                      </div>
              ...
              <VariantCard title="Transcoding presets submenu with profile-catalog formatting" source={`${settings} > Transcoding Presets`} classes={["panel-header", "panel-title-row", "settings-sidebar-stack", "transcode-presets-settings-panel", "compatibility-profile-list", "compatibility-profile-catalog-list", "settings-profile-toggle-row", "transcode-automation-toggle-row", "transcode-automation-tab-controls", "transcode-automation-tab-list", "transcode-automation-tab-button", "transcode-automation-tab-label", "settings-profile-toggle-actions", "transcode-automation-section", "transcode-automation-content", "compatibility-profile-search", "compatibility-profile-search-icon", "compatibility-profile-search-clear", "compatibility-profile-list-item", "compatibility-profile-list-row", "quality-profile-list-row", "compatibility-profile-list-trigger", "compatibility-profile-list-copy", "transcode-automation-list-copy", "compatibility-profile-quick-actions", "compatibility-profile-quick-action", "transcode-preset-placeholder", "transcode-preset-placeholder-body", "panel-empty-state", "panel-empty-state-icon", "settings-panel-header-action"]} wide>
                <div className="panel-header"><div className="panel-title-row"><h2>Transcoding Presets</h2><TooltipTrigger ariaLabel="Explain transcoding presets" content="Manage reusable stream presets and future filename or foldername presets.">?</TooltipTrigger></div></div>
                <div className="settings-sidebar-stack transcode-presets-settings-panel">
                  <div className="compatibility-profile-list compatibility-profile-catalog-list">
                    <div className="settings-profile-toggle-row transcode-automation-toggle-row">
                      <div className="transcode-automation-tab-controls"><div className="transcode-automation-tab-list" role="tablist" aria-label="Transcoding preset categories" aria-orientation="horizontal"><button type="button" role="tab" className="transcode-automation-tab-button active" aria-selected="true"><span className="transcode-automation-tab-label">Presets</span></button><button type="button" role="tab" className="transcode-automation-tab-button" aria-selected="false"><span className="transcode-automation-tab-label">Filename presets</span></button><button type="button" role="tab" className="transcode-automation-tab-button" aria-selected="false"><span className="transcode-automation-tab-label">Foldername presets</span></button></div></div>
                     ...
                     <section className="transcode-automation-tab-content">
                      <div className="compatibility-profile-list">
                        <div className="settings-profile-toggle-row transcode-automation-toggle-row transcode-automation-standalone-header" data-settings-search-target="transcoding-federation-members">
                          <div className="transcode-automation-standalone-heading"><strong>Federation members</strong><TooltipTrigger ariaLabel="Explain federation members" tooltipClassName="transcode-automation-description-tooltip-portal transcode-automation-description-tooltip-portal-compact" maxWidth={300} align="start" placement="center" content={<div className="transcode-automation-description-tooltip"><p>Review trusted federation installations and their reachability.</p><p>Pairing is direct; members are not used as relays.</p></div>}>?</TooltipTrigger></div>
          ...
          <CatalogSection definition={catalogSections[11]}>
            <VariantGroup title="Dialogs, popovers, tooltips">
              ...
              <VariantCard title="Transcoding settings stack order" source="TranscodingSettingsPanel" classes={["settings-sidebar-stack", "transcode-automation-section", "transcode-automation-content", "transcode-automation-panel-body", "transcode-automation-standalone-header", "transcode-automation-standalone-heading", "transcode-automation-section-chevron", "settings-profile-toggle-actions", "settings-panel-header-action", "transcode-federation-panel", "transcode-federation-heading", "transcode-federation-members"]} wide>
                <div className="settings-sidebar-stack">
                  <section className="app-settings-section transcode-automation-section">
                    <div className="compatibility-profile-panel transcode-automation-content">
                      <div className="settings-profile-toggle-row transcode-automation-toggle-row transcode-automation-standalone-header"><button type="button" className="transcode-automation-section-chevron" aria-label="Expand Accelerators" title="Expand Accelerators" aria-expanded="false" aria-controls="catalog-stack-accelerators"><ChevronRight aria-hidden="true" className="nav-icon" /></button><div className="transcode-automation-standalone-heading"><strong>Accelerators</strong><TooltipTrigger ariaLabel="Explain accelerators" content="Inspect the real FFmpeg hardware probes.">?</TooltipTrigger></div><div className="settings-profile-toggle-actions"><button type="button" className="secondary small settings-panel-header-action"><FlaskConical aria-hidden="true" size={16} />Test Hardware</button></div></div>
                  ...
                  <section className="app-settings-section transcode-automation-section">
                    <div className="compatibility-profile-panel transcode-automation-content">
                      <div className="settings-profile-toggle-row transcode-automation-toggle-row transcode-automation-standalone-header"><button type="button" className="transcode-automation-section-chevron" aria-label="Expand Automation Rules" title="Expand Automation Rules" aria-expanded="false" aria-controls="catalog-stack-rules"><ChevronRight aria-hidden="true" className="nav-icon" /></button><div className="transcode-automation-standalone-heading"><strong>Automation Rules</strong><TooltipTrigger ariaLabel="Explain automation rules" content="Rules select a preset when their conditions match.">?</TooltipTrigger></div><div className="settings-profile-toggle-actions"><button type="button" className="secondary small settings-panel-header-action" disabled><Plus aria-hidden="true" size={14} />New rule</button></div></div>
