        ...
        <div className="ui-elements-content">
          ...
          <CatalogSection definition={catalogSections[10]}>
            <VariantGroup title="Duplicates, paths, telemetry">
              ...
              <VariantCard title="Direct transcode federation pairing" source="TranscodeFederationPanel" classes={["transcode-federation-panel", "transcode-federation-heading", "panel-title-row", "tooltip-trigger", "icon-only-button", "transcode-federation-code-action", "transcode-federation-subheading", "transcode-federation-code-row", "transcode-federation-addresses", "transcode-federation-address-grid", "transcode-federation-address-group", "transcode-federation-address-list", "field-label", "transcode-federation-fields", "transcode-federation-pairing", "transcode-federation-pair-form", "transcode-federation-peer", "transcode-federation-members", "transcode-federation-member", "transcode-federation-member-main", "transcode-federation-member-details", "transcode-federation-member-actions", "transcode-federation-resources", "transcode-federation-identity", "status-dot", "app-settings-flag-toggle", "badge"]} wide>
                <section className="transcode-federation-panel">
                  <div className="transcode-federation-heading">
                    <div><div className="panel-title-row"><h3><Server aria-hidden="true" />Transcode federation</h3><TooltipTrigger ariaLabel="Explain transcode federation" content="Pair trusted MediaLyze installations directly and let compatible workers execute structured transcode plans without exposing library paths.">?</TooltipTrigger></div></div>
                  ...
                  <div className="transcode-federation-code-row"><label className="field"><span>Pairing code</span><input className="settings-choice-input" readOnly value="mLz-7Wq2-8Nf4" onChange={() => undefined} /></label><TooltipTrigger ariaLabel="Copy code" content="Copy code" className="secondary icon-only-button transcode-federation-code-action" pinOnClick={false}><Copy aria-hidden="true" className="nav-icon" size={16} /></TooltipTrigger><TooltipTrigger ariaLabel="Reset code" content="Reset code" className="secondary icon-only-button transcode-federation-code-action" pinOnClick={false}><History aria-hidden="true" className="nav-icon" size={16} /></TooltipTrigger></div>
                  <div className="transcode-federation-addresses"><div className="transcode-federation-subheading"><strong>Reachable network addresses</strong><span className="field-hint">Use one of these addresses when pairing another installation.</span></div><div className="transcode-federation-address-grid"><div className="transcode-federation-address-group"><span className="field-label">Hostname</span><div className="transcode-federation-address-list"><code>http://medialyze-nas.local:8091</code></div></div><div className="transcode-federation-address-group"><span className="field-label">IP address</span><div className="transcode-federation-address-list"><code>http://192.168.1.20:8091</code></div></div></div></div>
