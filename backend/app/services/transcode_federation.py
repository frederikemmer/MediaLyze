...
def _remote_media_snapshot(media_file: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "content_category": getattr(getattr(media_file, "content_category", "main"), "value", getattr(media_file, "content_category", "main")) or "main",
        "series_name": getattr(getattr(media_file, "series", None), "title", None),
        "season_number": getattr(getattr(media_file, "season", None), "season_number", None),
