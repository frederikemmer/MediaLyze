...
SQLITE_ADDITIVE_COLUMNS: dict[str, dict[str, str]] = {
    "libraries": {
        ...
        "duplicate_detection_mode": "ALTER TABLE libraries ADD COLUMN duplicate_detection_mode VARCHAR(32) NOT NULL DEFAULT 'filename'",
    },
    "media_files": {
...
SQLITE_INDEX_STATEMENTS: tuple[str, ...] = (
    ...
    "CREATE INDEX IF NOT EXISTS ix_libraries_duplicate_detection_mode ON libraries (duplicate_detection_mode)",
    "CREATE INDEX IF NOT EXISTS ix_media_files_library_content_hash ON media_files (library_id, content_hash)",
    "CREATE INDEX IF NOT EXISTS ix_media_files_library_duplicate_group_key ON media_files (library_id, duplicate_group_key)",
    "CREATE INDEX IF NOT EXISTS ix_media_files_library_duplicate_group_member_count ON media_files (library_id, duplicate_group_member_count)",
